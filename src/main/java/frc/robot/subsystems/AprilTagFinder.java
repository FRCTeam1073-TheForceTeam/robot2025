...
public class AprilTagFinder extends SubsystemBase 
{
  ...
  public final Transform3d fLCamTransform3d = new Transform3d(new Translation3d(-0.2787,0.4198, 0.123), new Rotation3d(0, 0, (Math.PI) / 4));  // front left has the new mount
  public final Transform3d fRCamTransform3d = new Transform3d(new Translation3d(-0.2787, 0.4198, 0.123), new Rotation3d(0, 0, -(Math.PI) / 4));
