...
public class LeftScore2Coral 
{
    public static Command create(boolean isRed, Drivetrain drivetrain, FieldMap map, Localizer localizer, CoralEndeffector endEffector, CoralElevator elevator, Lidar lidar, int branchLevel)  
    {
        ...
        Pose2d tag11RightApproachPose = map.getTagRelativePose(11, 1, new Transform2d(AutoConstants.scoreApproachOffsetX, 0, new Rotation2d(Math.PI)));
        Pose2d tag11LeftApproachPose = map.getTagRelativePose(11, -1, new Transform2d(AutoConstants.scoreApproachOffsetX, 0, new Rotation2d(Math.PI)));
        ...
        Pose2d tag20RightApproachPose = map.getTagRelativePose(20, 1, new Transform2d(AutoConstants.scoreApproachOffsetX, 0, new Rotation2d(Math.PI)));
        Pose2d tag20LeftApproachPose = map.getTagRelativePose(20, -1, new Transform2d(AutoConstants.scoreApproachOffsetX, 0, new Rotation2d(Math.PI)));
        ...
        if (isRed)
        {
            segments1.add(new Segment(start, tag11LApproach, tag11LeftApproachPose.getRotation().getRadians(), AutoConstants.scoringAlignmentVelocity));
            ...
            segments1.add(new Segment(redI1, tag11RApproach, tag11RightApproachPose.getRotation().getRadians(), AutoConstants.scoringAlignmentVelocity));
        ...
        {
            segments1.add(new Segment(start, tag20LApproach, tag20LeftApproachPose.getRotation().getRadians(), AutoConstants.scoringAlignmentVelocity));
            ...
            segments3.add(new Segment(blueI1, tag20RApproach, tag20RightApproachPose.getRotation().getRadians(), AutoConstants.scoringAlignmentVelocity));
