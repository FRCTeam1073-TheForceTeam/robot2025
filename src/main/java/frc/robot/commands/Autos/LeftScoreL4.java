...
public class LeftScoreL4 
{
    public static Command create(boolean isRed, Drivetrain drivetrain, FieldMap map, Localizer localizer, CoralEndeffector endEffector, CoralElevator elevator, Lidar lidar)  
    {
        ...
        Pose2d redIntermediatePose = map.getTagRelativePose(11, 0, new Transform2d(1, 0, new Rotation2d(Math.PI)));
        ...
        Pose2d blueIntermediatePose = map.getTagRelativePose(20, 0, new Transform2d(1, 0, new Rotation2d(Math.PI)));
