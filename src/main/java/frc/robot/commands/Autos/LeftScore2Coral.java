...
public class LeftScore2Coral 
{
    public static Command create(boolean isRed, Drivetrain drivetrain, FieldMap map, Localizer localizer, CoralEndeffector endEffector, CoralElevator elevator, Lidar lidar, AprilTagFinder finder, int branchLevel)  
    {
        ...
        Point tag6LApproach = new Point(tag6LeftApproachPose.getX(), tag6LeftApproachPose.getY() - 0.25);
        Point tag11RApproach = new Point(tag11RightApproachPose.getX(), tag11RightApproachPose.getY() - 0.25);
        ...
        Point tag19LApproach = new Point(tag19LeftApproachPose.getX(), tag19LeftApproachPose.getY() - 0.25);
        Point tag20RApproach = new Point(tag20RightApproachPose.getX(), tag20RightApproachPose.getY() - 0.25);
